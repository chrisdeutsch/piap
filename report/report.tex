...
Generally, a high acceptance rate leads to slow mixing of the Markov-Chain, which means that the state moves slowly through state-space.
Conversely a low acceptance gives rise to rapid mixing of the chain and a thorough exploration of the state-space.

...
\begin{figure}[p]
	\begin{subfigure}{1.0\textwidth}
		...
		\subcaption{Coulomb potential with hard core}
...
In the following sections the average pair distance~$d$ was simulated for different thermodynamic~$\beta$ and is depicted in $d(\beta)$-Graphs using bands to indicate the $1\sigma$-range and 0.05/0.95-quantiles.

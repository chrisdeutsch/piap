...
%Hier Folien
\begin{frame}{Results -- Lennard-Jones}
	\pause
	\centering
...
\begin{frame}
	\frametitle{Results -- Lennard-Jones @ $\beta=1$}
	\centering
	\begin{columns}	
		\column[c]{0.6\textwidth}
		\begin{figure}
...
\begin{frame}
	\frametitle{Results -- Lennard-Jones @ $\beta=5$}
	\centering
	\begin{columns}	
		\column[c]{0.6\textwidth}
		\begin{figure}
...
\begin{frame}
	\frametitle{Results -- Lennard-Jones @ $\beta=10$}
	\centering
	\begin{columns}	
		\column[c]{0.6\textwidth}
		\begin{figure}
...
\begin{frame}
	\frametitle{Results -- Lennard-Jones @ $\beta=100$}
	\centering
	\begin{columns}	
		\column[c]{0.6\textwidth}
		\begin{figure}
